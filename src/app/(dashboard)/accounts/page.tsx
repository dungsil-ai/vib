...
export default function AccountsPage() {
  ...
  const [formData, setFormData] = useState({ name: '', description: '', currency: 'KRW' })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setShowFormFor(null)
        setFormData({ name: '', description: '', currency: userCurrency })
        fetchAccounts()
      }
    } catch {
          ...
          return (
            <div key={type} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border dark:border-gray-700">
              ...
              {isFormOpen ? (
                <div className="p-4 border-t dark:border-gray-700">
                  ...
                  <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-3">
                    ...
                    <div className="col-span-2 flex gap-2">
                      ...
                      <button
                        type="button"
                        onClick={() => { setShowFormFor(null); setFormData({ name: '', description: '', currency: userCurrency }); setFormError('') }}
                ...
                <div className="p-3">
                  <button
                    onClick={() => { setShowFormFor(type); setFormData({ name: '', description: '', currency: userCurrency }); setFormError('') }}
